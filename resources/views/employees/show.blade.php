...
body.dark .bg-danger  { background: rgba(220,38,38,0.18);  color: #f87171; }
body.dark .bg-warning { background: rgba(217,119,6,0.18);  color: #fbbf24; }
body.dark .bg-primary { background: rgba(37,99,235,0.18);  color: #60a5fa; }
...
<div class="show-wrapper">
    <div class="profile-card">
        ...
        <div class="profile-header">
            ...
            <a href="{{ route('superAdmin.superAdmin') }}" class="manage-link">
